  ...
  Widget _crearImagen() {
    return Container(
      ...
      child: FadeInImage(
        ...
        image: NetworkImage('https://www.photographytalk.com/images/articles/2017_1/iStock-545347988.jpg'),
        fit: BoxFit.cover,
        height: 250.0,
      )
    );
